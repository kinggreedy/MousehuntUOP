...
luxCountdownExpand.prototype._updateTimer=function() {
	...
	{
		e = 200 - e;
		this._theTimer.getElementsByClassName("lux-countdown-text")[0].setAttribute('state','DOWN');
	}
	else
	{
		this._theTimer.getElementsByClassName("lux-countdown-text")[0].setAttribute('state','UP');
	}
	if (e < 0) e = 0;
...
luxCountdownExpand.prototype._startTimer=function() {
	...
	if((h.getTime()>this._start.getTime())) {
		...
		if(j>0) {
			...
			d=Math.floor(((j%(60*60*1000))%(60*1000))/1000*1);
			g=this._addZero(g);
			b=this._addZero(b);
			d=this._addZero(d)
		}
		...
		var c=dhourStr+this._timeSeparator+dminStr+this._timeSeparator+dsecStr;
